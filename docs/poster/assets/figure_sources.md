...
| `fig03_two_axis_results.svg` | AUPRC ranking vs operating-point result split | XGBoost F4 AUPRC 0.992338 [0.950179, 0.999336]; S8B_R2 AUPRC 0.986020 [0.929981, 0.998966]; no-skill PR baseline 0.900705; family-aware encoder MCC 0.603489 | Exact honesty caveat inside the result band. |
...
- Do not infer biological causality from graph arrows, attention, gates, FiLM, masking, embeddings, or feature-family effects.
